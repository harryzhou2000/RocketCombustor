...
diameter_nozzle= 2.08e-02 #0.5*diameter_chamber  # 0.75,0.5
diameter_exit= 2.5e-02 #0.8*diameter_chamber   # 1.25,0.8
...
length_chamber= 0.1 #0.5*diameter_chamber  #1.0，0.4

length_converge= 0.1*diameter_chamber #0.5
length_diverge= 0.1*diameter_chamber  #1.0

num_cpts_converge= 10
num_cpts_diverge= 10
